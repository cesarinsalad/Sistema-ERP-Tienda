        ...
        <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4" style="border-radius: 1.25rem 1.25rem 0 0;">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 font-weight-bold" style="color: #334155;">
                    <i class="fas fa-tag mr-2 text-purple" style="color: #7D266E;"></i> Detalles de la Marca
                </h5>
        ...
        <div class="card-body px-4 pb-4 pt-3">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <p class="text-muted small font-weight-bold text-uppercase mb-1" style="letter-spacing: 0.05em;">Nombre de la Marca</p>
                    <h6 class="font-weight-bold text-dark m-0" style="font-size: 1.1rem;">{{ $brand->name }}</h6>
                </div>
            </div>
        </div>
    </div>
