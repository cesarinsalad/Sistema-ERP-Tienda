            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 1.25rem;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <h3 class="font-weight-bold text-dark m-0" style="letter-spacing: -0.5px;">Marcas Inactivas</h3>
                            <p class="text-muted small m-0 mt-1"><i class="fas fa-archive mr-1"></i> Archivo de marcas y fabricantes fuera de catálogo</p>
                        </div>
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <form action="{{ route('brands.inactivos') }}" method="GET" class="form-inline mb-0">
                            ...
                            @if(request('search'))
                                <a href="{{ route('brands.inactivos') }}" class="btn btn-link text-muted ml-2 font-weight-bold">Limpiar</a>
                            @endif
                        </form>
                    </div>
                </div>
