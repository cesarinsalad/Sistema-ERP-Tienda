            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 1.25rem;">
                <div class="card-body p-4">
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <form action="{{ route('articulo.index') }}" method="GET" class="form-inline mb-0">
                            ...
                            @if(request('search'))
                                <a href="{{ route('articulo.index') }}" class="btn btn-link text-muted ml-2 font-weight-bold">Limpiar</a>
                            @endif
                        </form>
                    </div>
                </div>
